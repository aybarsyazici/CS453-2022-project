...
/** Check if the given lock is currently locked atomically without locking
 * @param lock Lock to check
 * @return Whether the lock is currently locked
 * **/
bool shared_lock_is_locked(struct shared_lock_t* lock);
